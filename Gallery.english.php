...
Copyright 2006-2021 SMFHacks.com
...
$txt['gallery_text_category'] =	'Gallery';
$txt['gallery_text_parentcategory'] =	'Parent Gallery';
$txt['gallery_text_catnone'] =	'(None)';
$txt['gallery_text_choose_cat'] =	'Select Gallery';

$txt['gallery_text_adminpanel'] = 'Gallery Admin Panel';
$txt['gallery_text_addcategory'] = 'Add Gallery';
$txt['gallery_text_cat_disableratings'] = 'Disable Image Ratings';
$txt['gallery_text_lock_category'] = 'Lock Gallery from uploads';
$txt['gallery_text_editcategory'] = 'Edit Gallery';
$txt['gallery_text_delcategory'] = 'Delete Gallery';
...
$txt['gallery_text_importpics'] = '[Import Pictures]';
$txt['gallery_text_regeneratethumbnails'] = '[Regenerate Thumbnails]';
$txt['gallery_text_regeneratethumbnails2'] = 'Regenerate Thumbnails';
$txt['gallery_regen_notes'] = 'This will regenerate all thumbnails in this Gallery. The sizes used for the thumbnails will be the current thumbnail settings.  Could take a while depending on the amount of the pictures in the Gallery. You will be redirected to the Gallery when completed.';

$txt['gallery_text_prev'] = 'Previous Image';
$txt['gallery_text_next'] = 'Next Image';
...
$txt['gallery_text_returnpicture'] = 'Return to Picture';
//Online strings
...
$txt['gallery_write_catpatherror'] = 'Warning Gallery Image Path is not writable! ';
$txt['gallery_form_filenameicon'] = 'Gallery Icon Filename:';

$txt['gallery_warn_category'] = 'Warning this WILL DELETE this Gallery and ALL pictures, comments, ratings that Gallery contains...';

$txt['gallery_form_addpicture'] = 'Add Picture';
$txt['gallery_form_category'] =	'Gallery:';
...
$txt['gallery_set_commentschoice'] = 'Allow the user to toggle if comments can be shown on a picture or not.';
...
$txt['gallery_set_images_per_row'] = 'Images per row:';
...
$txt['gallery_set_enable_multifolder'] = 'Enable multiple folders for picture storage';
$txt['gallery_index_toprated'] = 'Show top rated pictures on the main page';
...
$txt['gallery_index_showusergallery'] = 'Show user gallery on gallery index';
...
$txt['gallery_catthumb_settings'] = 'Gallery Thumbnail Settings';
...
$txt['gallery_set_cat_height'] = 'Max Gallery image height:';
$txt['gallery_set_cat_width'] = 'Max Gallery image width:';
...
//Search Page
$txt['gallery_search_pic'] = 'Search for Pictures';
...
$txt['gallery_main_featured'] = 'Featured Pictures';
...
$txt['gallery_stats_totalpics'] = 'Total Pictures';
...
$txt['gallery_bulk_returntocat'] = 'Return to Gallery';
$txt['gallery_bulk_notitle'] = 'Title is required for bulk upload #';

$txt['gallery_text_import'] = 'Import Pictures';
...
$txt['gallery_import_notes'] = 'Notes: This will import all pictures in the folder under the current Gallery selected. The title for each image will be the filename. Also it does respect limits on image width, height and size and will not upload them if they exceed it.';
//Add Sub Category
$txt['gallery_text_addsubcat'] = 'Add Sub Gallery';
//Board
$txt['gallery_text_postingoptions'] = 'Posting Options';
$txt['gallery_text_boardname'] = 'Board Name:';
$txt['gallery_postingoptions_info'] = 'Information: If you select a board, on a new gallery image that is approved a post will be created.';
...
$txt['gallery_text_catpermlist'] = 'Gallery Permission List';
$txt['gallery_text_catpermlist2'] = 'Gallery Permissions';
$txt['gallery_text_catperm'] = 'Gallery Permission';
...
//Gallery.php Strings
//#############################
$txt['gallery_error_cat_title'] = 'You need to enter a Gallery title!';
...
$txt['gallery_error_no_cat'] = 'You need to select a Gallery.';
...
$txt['gallery_error_nocat_above'] = 'There is no Gallery above the current one.';
$txt['gallery_error_nocat_below'] = 'There is no Gallery below the current one.';
$txt['gallery_error_norate_own'] = 'You can not rate your own picture.';
$txt['gallery_error_no_catexists'] = 'You need to create a Gallery first before you upload a picture.';
//Quota Limits
...
//Permissions
$txt['gallery_perm_no_view'] = 'You are not allowed to view this Gallery.';
$txt['gallery_perm_no_add'] = 'You are not allowed to add a item in this Gallery.';
$txt['gallery_perm_no_edit'] = 'You are not allowed to edit that item in this Gallery.';
$txt['gallery_perm_no_delete'] = 'You are not allowed to delete that item in this Gallery.';
$txt['gallery_perm_no_ratepic'] = 'You are not allowed to rate that item in this Gallery.';
$txt['gallery_perm_no_editcomment'] = 'You are not allowed to edit that comment in this Gallery.';
$txt['gallery_perm_no_addcomment'] = 'You are not allowed to leave comments in this Gallery.';
$txt['gallery_perm_no_report'] = 'You are not allowed to report content in this Gallery.';
$txt['gallery_perm_no_autoapprove'] = 'You are not allowed to autoapprove content in this Gallery.';
//Notify comment
...
$txt['gallery_perm_edit'] = 'Edit own Picture';
$txt['gallery_perm_delete'] = 'Delete own Picture';
$txt['gallery_perm_addcomment'] = 'Add Comment';
$txt['gallery_perm_autoapprove'] = 'Auto Approve';

$txt['gallery_permerr_permexist'] = 'A permission already exists for this group and Gallery please delete it first.';
...
$txt['gallery_user_privategallery'] = 'Private Gallery';
...
$txt['gallery_ftp_selectcategory'] = '(Select a Gallery)';
...
$txt['gallery_ftp_err_nocatnousercat'] = 'You need to select a Gallery or user Gallery to upload pictures to';
$txt['gallery_ftp_err_catandusercat'] = 'Only select a Gallery or user Gallery but not both.';
...
$txt['gallery_txt_picturemoveoptions'] = 'Picture Move Options:';
$txt['gallery_movetousergallery'] = '[Move to User Gallery]';
$txt['gallery_movetomaingallery'] = '[Move to Main Gallery]';

$txt['gallery_txt_changepiclocation'] = 'Change Gallery Location for Picture';
...
$txt['gallery_err_comment_rating'] = 'A comment is required on this picture before you can rate it.';
...
$txt['gallery_text_rotate_image'] =	'Rotate Image By Degrees';
...
$txt['gallery_txt_featured_image'] = 'Featured Image';
...
$txt['gallery_share_addthis'] = 'Show share button for Addthis';
$txt['gallery_share_googleplus'] = 'Show share on Google+';
$txt['gallery_share_facebooklike'] = 'Show Facebook Like Button';

$txt['gallery_txt_share'] = 'Share';

$txt['gallery_set_show_cat_latest_pictures'] = 'Show latest post column on gallery view';

$txt['gallery_last_post'] = '<b>Last post</b> by';
$txt['gallery_latest_posts'] = 'Latest Posts';
$txt['gallery_txt_on'] = 'on ';

$txt['gallery_set_show_subcategory_links'] = 'Hide subgallery link display under the parent gallery';
$txt['gallery_perm_no_addvideo'] = 'You are not allowed to add video/audio in this gallery.';
...
$txt['gallery_txt_multi_imageuploaded'] = 'Image was uploaded:';
...
$txt['gallery_txt_multi_upload_failed_load'] = 'Multiupload failed to load. An issue occured....';
...
// Copy Images
$txt['gallery_txt_copy_item'] = 'Copy item to another gallery';
$txt['gallery_txt_copy_item2'] = 'Copy item';
$txt['gallery_txt_copy_item3'] = ' [Copy item]';
$txt['gallery_set_allow_copy'] = 'Allow copying of a gallery item to another gallery';
...
$txt['gallery_txt_set_category_thumbnail'] = 'Set as Gallery Thumbnail';
...
$txt['gallery_txt_allow_ratings'] = 'Allow image rating';


$txt['gallery_set_picture_information_last'] = 'Show picture information last. Comments are shown first';
...
$txt['gallery_error_img_size_height2'] = 'Image too smaler requirements. Your height was:  ';
...
// SMF Gallery 5.0
$txt['gallery_set_aviary'] = 'Aviary Image Effects';
$txt['gallery_set_aviary_publickey'] = 'Aviary Public Key:';
$txt['gallery_get_aviary_publickey'] = 'Get Aviary Key <a href="https://developers.aviary.com/signin" target="_blank">http://www.aviary.com</a>';
...
$txt['gallery_txt_userdefaultcategorydescription'] = 'Default my gallery gallery';
$txt['gallery_set_createusercat'] = 'Create a Default User Gallery';
...
';
$txt['gallery_twitter_step1'] = 'Step 1: Register an App <a href="http://dev.twitter.com/apps" target="_blank>http://dev.twitter.com/apps</a> and fill out the settings below.';
...
$txt['gallery_approvelist_description'] = 'Approve images and review reported images';
...
$txt['gallery_artists'] = 'Select Artist: ';
$txt['gallery_artists_types'] = 'Gallery Types: ';
